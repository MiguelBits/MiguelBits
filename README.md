...
- **🍊SATSUMA**: Built a DEX with Concentrated Liquidity from scratch, making use of current voting/locking/emission models to achieve a new o(3,3) model of sustainable growth, [Website](satsuma.exchange) [EthGlobal Winner](https://ethglobal.com/showcase/triple-orange-vb53f)
...
- **🥞PANCAKESWAP**: My project won V4 hackhaton [EthGlobal Winner](https://x.com/PancakeSwap/status/1812584895127998580?t=QtIKzQCJU-9_IMiHn85yUg&s=19)
- **🩵LiquityV2**: My Leverage without Liquidation project won a hackhaton [EthGlobal Winner](https://ethglobal.com/showcase/luni-chan-esmqn)
